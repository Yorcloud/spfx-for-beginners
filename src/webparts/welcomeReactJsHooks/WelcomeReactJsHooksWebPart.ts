...
import { IWelcomeReactJsHooksProps } from "./components/IWelcomeReactJsHooksProps";
import {
  ThemeProvider,
  ThemeChangedEventArgs,
  IReadonlyTheme,
} from "@microsoft/sp-component-base";
import WelcomeReactJsHooks from "./components/WelcomeReactJsHooks";


export interface IWelcomeReactJsHooksWebPartProps {
  title: string;
  messagestyle: string;
...
export default class WelcomeReactJsHooksWebPart extends BaseClientSideWebPart<IWelcomeReactJsHooksWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IWelcomeReactJsHooksProps> = React.createElement(
      WelcomeReactJsHooks,
      {
